...
<div class="sidebar">
	...
	<button id="sidebar_button" onclick="window.location.href='../supplier/add_supplier.php'"><i class="fas fa-user-plus"></i> Add Supplier</button>
	<button id="sidebar_button" type="button" data-toggle="popover" title="Supplier Management" data-content="Here you can create, update, delete and view supplier profiles." data-placement="bottom"><i class="fas fa-question"></i> Help</button>
